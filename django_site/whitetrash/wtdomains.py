...
class WTDomainUtils():
    ...
    def is_whitelisted(domain):
        ...
        #TODO write tests to exercise this
        ...
        return Whitelist.objects.filter(Q(enabled=True,domain=domain,protocol=protocol) | 
                Q(enabled=True,domain=self.all_wildcard(domain),protocol=protocol,wildcard=get_wildcard_choice("ALL")) |
                Q(enabled=True,domain=self.one_label_wildcard(domain),protocol=protocol,wildcard=get_wildcard_choice("ONE")))
